        ...
        <div className="space-y-1.5">
          {qaData.map((item, index) => {
            ...
            return (
              ...
              >
                <p className="font-heading text-lighter text-lg">{item.question}</p>
                <AnimatePresence>
                  {isOpen && (
                    <motion.p
                      className="mt-2 pl-1 md:pl-10 text-lighter pr-4 paragraph"
